...
public class NoticeInfoCreationRequest {
	...
	@Length(max = 128, message = "제목의 최대 길이는 128자 입니다.")
	private String title;
	
	@NotBlank(message = "내용은 필수입력 사항입니다.")
	@Length(max = 1024, message = "내용의 최대 길이는 1024자 입니다.")
	private String contents;
	
	@NotBlank(message = "작성자는 필수입력 사항입니다.")
	@Length(max = 10, message = "작성자의 최대 길이는 10자 입니다.")
